    ...
    public static function section() {
		...
		$html_fep_informations = '<div class="content-helpus">';
			...
			$html_fep_informations .= '<div class="col2">';
				$html_fep_informations .= '<h4>' . __('Thanks for using our plugin. It\'s free for all Wordpress and Elementor users.','flexible-editor-panel') . '</h4>';
				$html_fep_informations .= '<p>' . __('Please give us 5 minutes of your time to support us.','flexible-editor-panel') . '</p>';
				$html_fep_informations .= '<p><a href="' . __('https://wordpress.org/support/plugin/flexible-elementor-panel/reviews/?filter=5/#new-post','flexible-editor-panel') . '" target="_blank">' . __('Give us a positive rating directly in the Wordpress plugin repository. Thanks!','flexible-editor-panel') . '</a></p>';
				$html_fep_informations .= '<p>' . __('Don\'t forget, we are open to all helpful suggestions on our <a href="https://wordpress.org/support/plugin/flexible-elementor-panel/" target="_blank">support forum.</a>','flexible-editor-panel') . '</p>';
			$html_fep_informations .= '</div>';
		$html_fep_informations .='</div>';
